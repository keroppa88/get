...
| get / make | データソース | 主な収集対象 |
|---|---|---|
| usa | TradingView等 | **米国指数**: NYダウ・S&P500・ナスダック・ラッセル2000・SOX、**M7時価総額**、**個別株約35銘柄**（アップル・エヌビディア・TSMC・ASML・サムスン・SAP・LVMH・BYD等） |
| google | 株価収集POWER2 | 四本値で台湾韓国香港インド深圳ユーロ仏独英米VIX、S&P500業種別|
